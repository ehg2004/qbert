...
imgPlayerDownLeft =source_path+'/assets/sprites/playerleftdown.png'

imgPlayerDownRight =source_path+'/assets/sprites/playerdownright.png'

imgPlayerDownRightLives =source_path+'/assets/sprites/playerlittle.png'

imgPlayerUpLeft =source_path+'/assets/sprites/playerupleft.png'

imgPlayerUpRight =source_path+'/assets/sprites/playerupright.png'

imgPlayerDownLeftJump =source_path+'/assets/sprites/playerleftdownjump.png'

imgPlayerDownRightJump =source_path+'/assets/sprites/playerdownrightjump.png'

imgPlayerUpLeftJump =source_path+'/assets/sprites/playerupleftJump.png'

imgPlayerUpRightJump =source_path+'/assets/sprites/playeruprightjump.png'

imgPlayer =source_path+'/assets/sprites/playerleftdown.png'

imgRedBall =source_path+'/assets/sprites/redEnemyBall.png'

imgGreenBall =source_path+'/assets/sprites/greenEnemyBall.png'

imgNothingBall =source_path+'/assets/sprites/nothingEnemyBall.png'

imgPlayerSwear =source_path+'/assets/sprites/swearqbert.png'

imgPlayerSpindownleft =source_path+'/assets/sprites/downleftspin.png'

imgPlayerSpindownright =source_path+'/assets/sprites/downrightspin.png'

imgDisk =source_path+'/assets/sprites/disk.png'

imgPurpleBall=source_path+'/assets/sprites/purpleEnemyBall.png'

#imgPurpleBall= 'RedEnemyBall.png'

imgSnake=source_path+'/assets/sprites/snake.png'

imgLose=pygame.image.load(source_path+'/assets/sprites/qbertloses.png')

imgStart=pygame.image.load(source_path+'/assets/sprites/startscreenqbert.jpg')

imgWin=pygame.image.load(source_path+'/assets/sprites/qbertloses.png')
...
sndQBJump = pygame.mixer.Sound(source_path+'/assets/audio/jump1.wav')  #load sound

sndQBDeath1 = pygame.mixer.Sound(source_path+'/assets/audio/jump1.wav') #load sound

sndQBDeath2 = pygame.mixer.Sound(source_path+'/assets/audio/jump1.wav') #load sound

sndQBWin = pygame.mixer.Sound(source_path+'/assets/audio/jump1.wav') #load sound

sndEnemyJump = pygame.mixer.Sound(source_path+'/assets/audio/jump2.wav')

sndQBStart = pygame.mixer.Sound(source_path+'/assets/audio/gamestart.wav')
...
#check distance between qbert and disk
	...
	if ((160 - PlayerX)**2 + (350-PlayerY)**2 )<360:
...
while lives!=0:
	...
	while RunGame:
		...
		for x in range (0,7):
			...
			pygame.draw.polygon(winScreen, clrBlue, ((500-50*x,50+80*x), (450-50*x,80+80*x), (500-50*x,110+80*x),(550-50*x,80+80*x)))

			pygame.draw.polygon(winScreen, clrWhite, ((450-50*x,80+80*x), (500-50*x,110+80*x), (500-50*x,160+80*x),(450-50*x,130+80*x)))

			pygame.draw.polygon(winScreen, clrLightBlue, ((500-50*x,110+80*x), (550-50*x,80+80*x), (550-50*x,130+80*x),(500-50*x,160+80*x)))
		...
		for x in range (0,5):
			...
			pygame.draw.polygon(winScreen, clrBlue, ((500-50*x,210+80*x), (450-50*x,240+80*x), (500-50*x,270+80*x),(550-50*x,240+80*x)))

			pygame.draw.polygon(winScreen, clrWhite, ((450-50*x,240+80*x), (500-50*x,270+80*x), (500-50*x,320+80*x),(450-50*x,290+80*x)))

			pygame.draw.polygon(winScreen, clrLightBlue, ((500-50*x,270+80*x), (550-50*x,240+80*x), (550-50*x,290+80*x),(500-50*x,320+80*x)))
		...
		for x in range (0,3):
			...
			pygame.draw.polygon(winScreen, clrBlue, ((500-50*x,370+80*x), (450-50*x,400+80*x), (500-50*x,430+80*x),(550-50*x,400+80*x)))

			pygame.draw.polygon(winScreen, clrWhite, ((450-50*x,400+80*x), (500-50*x,430+80*x), (500-50*x,480+80*x),(450-50*x,450+80*x)))

			pygame.draw.polygon(winScreen, clrLightBlue, ((500-50*x,430+80*x), (550-50*x,400+80*x), (550-50*x,450+80*x),(500-50*x,480+80*x)))
		...
		if PlayerPosition not in list_of_positions and PlayerY<560 and PlayerY > PlayerX*8/5-766 and PlayerY > PlayerX*(-8)/5+686:
		...
		#seperate the tuple position, and draw a yellow square on that position 
				...
				pygame.draw.polygon(winScreen,clrYellow, ((PlayerX1+40,PlayerY1+20),(PlayerX1-10,PlayerY1+50),(PlayerX1+40,PlayerY1+80),(PlayerX1+90,PlayerY1+50)))
